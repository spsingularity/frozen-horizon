...
action at $R=0$. Two walls are analyzed: the canonical invariant-measure choice as the
primary branch, and the coordinate rule as a robustness check, paired
with conformal and minimal Higgs couplings respectively. The model retains the Starobinsky predictions
$n_s\simeq0.962$--$0.965$ and $r\simeq0.004$, and adds an approximately
...
of $0.24$ e-folds against an integer spacing of $0.94$--$0.99$, so that
...
$1.1\times10^{-3}$, and evaluating the official Planck 2018 low-$\ell$
Commander and SimAll likelihoods, we find that one integer of each branch is
excluded ($\Delta\chi^2=+13.6$ and $+8.5$), that the preferred integers give
