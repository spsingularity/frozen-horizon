...
excluded ($\Delta\chi^2=+13.4$ and $+8.2$), that the preferred integers give
...
integer of each model branch ($\Delta\chi^2=+13.4$ and $+8.2$), while the
...
$d\ln R$ & $2.000000$ & $1.125$ \\
$dR$ & $2.015873$ & $1.128$ \\
$d\phi\propto d\ln f_R$ (canonical) & $2.8090$--$2.8103$ & $1.291$ \\
\hline
\end{tabular}
\end{center}
...
$\Delta\chi^2=+13.4$ (coordinate branch, $p{=}62$) and $+8.2$ (invariant
...
each branch is excluded ($\Delta\chi^2=+13.4$ and $+8.2$), while the
...
regenerate from the released code (Zenodo DOI to be inserted at
acceptance), which contains the full pipeline from the action to the
