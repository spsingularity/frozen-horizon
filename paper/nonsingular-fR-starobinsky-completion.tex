...
counterpart---and one that does carry the look-elsewhere penalty
explicitly, $+1.70$ for the best single integer against $+0.99$
marginalized---and it responds directly to
...
can be rejected outright, and the $+13.6$ and $+8.5$ exclusions have no
