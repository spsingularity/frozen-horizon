...
detail at the unit spectral gap $\mu^2=d-1=3$ in $d=4$ spacetime
dimensions: the boundary kernel is
...
the sole negative eigenvalue and every inhomogeneous scalar harmonic is
Gaussian suppressed; the physical tensor harmonics are suppressed by a
separate bulk-Hessian argument; the classicalizing contour lies at
...
the exit occurs before a continuum diffusion coefficient is established.
In the worked example of the
