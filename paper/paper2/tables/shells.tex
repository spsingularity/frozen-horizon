...
\hline
\end{tabular}
\caption{Discrete $S^3$ shell crossings. Harmonic $n$ enters the long-wavelength sector at $N_n=\ln(n+1)$ exactly, injecting variance $\Delta V_n$. The effective noise amplitude $Q_n^{\rm eff}$ approaches the continuum value $Q_\nu(1)=7.8686$ from above, but the first shell exceeds it by a factor of three.}
\label{tab:shells}
\end{table}
