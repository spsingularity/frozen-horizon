...
\hline
\end{tabular}
\caption{Lensed $C_\ell$ ratios (featured over smooth) from CAMB at the reheating-determined $N_*$, for the two viable integers of the invariant-wall branch; the CAMB ratios are independently reproduced by CLASS to better than $1.1\times10^{-3}$ at every $\ell\le30$.}
\label{tab:cmbratios}
\end{table*}
